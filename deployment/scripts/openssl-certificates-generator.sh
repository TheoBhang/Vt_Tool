...
# This script generates TLS certificates for VTTool services
...
CA_DAYS_VALID=3650
CERT_SUBJECT="/C=COUNTRY/ST=STATE/L=CITY/O=ORGANIZATION/OU=VTTool"
ROOT_CERTIFICATE_AUTHORITY="VTToolRootCA"
